...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title) || empty($description) || $lecturer_id <= 0) {
        ...
        try {
            $stmt = $pdo->prepare("UPDATE courses SET title = ?, description = ?, lecturer_id = ?, status = ? WHERE id = ?");
            if ($stmt->execute([$title, $description, $lecturer_id, $status, $course_id])) {
            ...
            <div class="col-md-8">
                <div class="form-container">
                    <div class="page-header text-center">
                        ...
                        <p class="mb-0">Update course information and settings</p>
                    </div>
                    ...
                    <?php if ($has_students): ?>
                        <div class="alert alert-info" role="alert">
                            ...
                            <strong>Note:</strong> This course has enrolled students. Changes may affect their learning experience.
                        </div>
                    <?php endif; ?>
                    ...
                    <form method="POST" class="needs-validation" novalidate>
                            ...
                            <select class="form-select" id="lecturer_id" name="lecturer_id" required>
                                ...
                                <?php foreach ($lecturers as $lecturer): ?>
                                    <option value="<?php echo $lecturer['id']; ?>" 
                                            <?php echo ($lecturer['id'] == $course['lecturer_id']) ? 'selected' : ''; ?>>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-between">
                            ...
                            <div>
                                ...
                                <?php if (!$has_students): ?>
                                    <a href="dashboard.php?delete=<?php echo $course['id']; ?>" 
