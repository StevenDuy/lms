...
// Get user statistics
$stmt = $pdo->prepare("SELECT COUNT(*) as enrolled_courses FROM enrollments WHERE student_id = ?");
$stmt->execute([$user['id']]);
$stats['enrolled_courses'] = $stmt->fetch()['enrolled_courses'];

$stmt = $pdo->prepare("SELECT COUNT(*) as completed_courses FROM enrollments WHERE student_id = ? AND status = 'completed'");
$stmt->execute([$user['id']]);
$stats['completed_courses'] = $stmt->fetch()['completed_courses'];

$stmt = $pdo->prepare("SELECT COUNT(*) as total_tests FROM test_results WHERE student_id = ?");
$stmt->execute([$user['id']]);
$stats['total_tests'] = $stmt->fetch()['total_tests'];

$stmt = $pdo->prepare("SELECT AVG(percentage) as avg_grade FROM test_results WHERE student_id = ?");
$stmt->execute([$user['id']]);
$avg_grade = $stmt->fetch()['avg_grade'];
$stats['avg_grade'] = $avg_grade ? round($avg_grade, 2) : 0;
?>
            ...
            <div class="col-md-3">
                <div class="card stat-card text-center p-3">
                    <div class="card-body">
                        ...
                        <h3 class="fw-bold"><?php echo $stats['enrolled_courses']; ?></h3>
            ...
            <div class="col-md-3">
                <div class="card stat-card text-center p-3">
                    <div class="card-body">
                        ...
                        <h3 class="fw-bold"><?php echo $stats['completed_courses']; ?></h3>
            ...
            <div class="col-md-3">
                <div class="card stat-card text-center p-3">
                    <div class="card-body">
                        ...
                        <h3 class="fw-bold"><?php echo $stats['total_tests']; ?></h3>
            ...
            <div class="col-md-3">
                <div class="card stat-card text-center p-3">
                    <div class="card-body">
                        ...
                        <h3 class="fw-bold"><?php echo $stats['avg_grade']; ?>%</h3>
